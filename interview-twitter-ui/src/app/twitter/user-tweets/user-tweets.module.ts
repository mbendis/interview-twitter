...
import { UserNumbersComponent } from './user-numbers/user-numbers.component';
...
@NgModule({
  ...
  declarations: [UserTweetsContainerComponent, UserTweetsViewComponent, UserTweetsTableComponent, UserNumbersComponent],
})
